...
namespace Goering.EFDAL.Mapping.EVN
{
    ...
    /// TN_SUBPROJECT() 的映射类
    /// </summary>  
    public partial class TNSUBPROJECTMap: EntityTypeConfiguration<TNSUBPROJECTInfo>
    {
        /// <summary>
        /// 自定义映射
        /// </summary>
        public TNSUBPROJECTMap(bool loaddefine)
			:this()
        {
			...
			this.Property(t => t.CR_PROJECT_ID).IsRequired().HasMaxLength(36);
			...
			this.ToTable("TN_SUBPROJECT");
            			
			this.Property(t => t.CN_ID).HasColumnName("CN_ID"); 
            			
			this.Property(t => t.CR_PROJECT_ID).HasColumnName("CR_PROJECT_ID"); 
