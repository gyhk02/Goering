<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TPUPowder.aspx.cs" Inherits="Goering.Web.Technology.TPUPowder" %>
                    ...
                    <td style="vertical-align: top;">
                        <div style="height: 50px; border-bottom: solid 1px #9CB6EC;">
                            <div style="height: 50px; line-height: 50px; font-size: 20px; font-weight: bold; background-color: #4571D9; color: white; float: left; border-radius: 5px 5px 0px 0px;">
                                <span style="letter-spacing: 5px; padding: 0px 60px;">TPU Powder</span>
                            </div>
                        </div>
                        <div style="background-color:#EAF1FB; margin:10px 0px; text-align:center; padding:30px 0px; ">
                            
                            <div style="width: 100%; text-align: center">
                                <div style='margin: 10px;height:450px' id='v1'>
                                </div>

                                <script type='text/javascript'>
                                    CKobject.embed('../Style/ckplayer/ckplayer.swf', 'v1', 'ckplayer_a1', '680', '450', true, { f: '/Style/img/Technology/tpupowder.mp4', c: 0, b: 1, i: '' }, ['/Style/img/Technology/tpupowder.mp4']);
                                    </script>
