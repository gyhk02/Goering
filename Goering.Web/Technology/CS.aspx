<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CS.aspx.cs" Inherits="Goering.Web.Technology.CS" %>
                    ...
                    <td style="vertical-align: top;">
                        <div style="height: 50px; border-bottom: solid 1px #9CB6EC;">
                            <div style="height: 50px; line-height: 50px; font-size: 20px; font-weight: bold; background-color: #4571D9; color: white; float: left; border-radius: 5px 5px 0px 0px;">
                                <span style="letter-spacing: 10px; padding: 0px 60px;">CS</span>
                            </div>
                        </div>
                            ...
                            <div style="width: 100%; text-align: center">
                                <div style='margin: 10px' id='v1'>
                                    <script type='text/javascript'>
                                        CKobject.embed('../Style/ckplayer/ckplayer.swf', 'v1', 'ckplayer_a1', '680', '450', true, { f: '/Style/img/Technology/CS.mp4', c: 0, b: 1, i: '' }, ['/Style/img/Technology/CS.mp4']);
                                    </script>
                                </div>
                            </div>
                        </div>
